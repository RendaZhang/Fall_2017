...
$con= mysqli_connect('cse-curly.cse.umn.edu','F17CS4131U123','17351','F17CS4131U123','3306');
// Check connection
...
mysqli_query($con,"INSERT INTO tbl_accounts (acc_name, acc_login, acc_password) VALUES ('Renda Zhang', 'a', '". sha1($str3)."');");
